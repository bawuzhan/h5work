...
<title>2016全国大学生模拟E提案征集活动</title>

<!-- <script src="mobileshow.js" type="text/javascript"></script> -->
<link rel="stylesheet" href="<%=basePathV3 %>h5/college/animation.css" type="text/css">
<link rel="stylesheet" href="<%=basePathV3 %>h5/college/style.css" type="text/css">
...
<body>
<div class="page_vote_title">2016全国大学生<br>模拟E提案征集 <s:property value="flName" /></div>
<div class="page_vote">
  ...
  <table>
      ...
      <td class="Row2"><p class="portName"><a href="<%=pathV3 %>/h5/college/<s:property value="conf_id" />"><s:property value="content" /></a></p></td>
