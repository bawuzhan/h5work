...
(function(){
	...
	if(isWX){
		if(location.host != 't.people.com.cn'){
			location.href = 'http://t.people.com.cn/h5/wuyi';
			return;
		};
	};
	//loader
	var loader = {
		...
		elementsPath : 'http://i0.peopleurl.cn/microblog-v3/h5/wuyi/images/',
		elements : [ //需要加载的元素
	...
	'</div>';
		...
		'<div class="bg"></div>'+
			'<div class="toEditor"><a href="/h5/wuyi" class="btn_04" data-animationIn="fadeInUp 1.1s 0.5s" data-animation="wobble 3s 1s"><span>我也做一个</span></a>' + (isWX?('<a href="' + (iOS?'http://mp.weixin.qq.com/s?__biz=MjM5NzI3NDg4MA==&mid=202118832&idx=1&sn=537a80cac54948c45ea94ec135232d93#rd':'weixin://profile/people_rmw') + '" class="btn_05" style="margin-left:1em;" data-animationIn="fadeInUp 1.1s 0.5s"><span>关注赢大奖</span></a>'):'') + '</div></div>';
