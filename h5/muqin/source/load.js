...
(function(){
	...
	if(isWX){
		if(location.host != 't.people.com.cn'){
			location.href = 'http://t.people.com.cn/h5/muqin';
			return;
		};
	};
	//loader
	var loader = {
		...
		preview : function(data){
			...
			var html = '<div class="globalPackage"><div class="sound s_off"></div><div class="moveArr"></div></div><div class="scenery page_0' + this.style +  (this.firstItem && this.firstItem.src?' userScenery frameR':'') + '">' + (this.firstItem.src ? ('<div class="userImgBox" style="top:' + (Math.round((viewHeight - (this.firstItem.height * viewWidth / this.firstItem.width)) * 0.4)) + 'px"><div class="imgFrameTop"></div><div class="imgFrameBtm"></div><div class="imgFrameTit"></div><img src="' + this.firstItem.src + '" class="userImg"></div>'):'<div class="bg"></div>') +'<div class="title" data-animationIn="fadeInRight 1.5s 0"></div><div class="footer" data-animationIn="fadeInUp 1s 1s" data-animation="shine 2s 0 2"><div class="logo"></div></div></div>'+
	'</div>';
			...
			for (var i = 0; i < this.items.length; i++) {
				html += '<div class="scenery userScenery'+ (i % 2 == 0 ? '' : ' frameR') +'" data-autoNext="1000"><div class="userImgBox" data-animationIn="' + (animations[i % animations.length]) + '" style="top:' + (Math.round((viewHeight - (viewWidth / this.items[i]['width'] * this.items[i]['height'])) * 0.4)) + 'px"><div class="imgFrameTop"></div><div class="imgFrameBtm"></div><div class="imgFrameTit"></div>' + '<img '+ (i==0?'':'data-') +'src="' + this.items[i]['src'] + '" class="userImg"></div>';
				if(this.items[i]['txt']){
		...
		'<div class="bg"></div><div class="title" data-animationIn="fadeInDown 1s 0"></div><div class="footer" data-animationIn="fadeInUp 1s 1s" data-animation="shine 2s 0 1"><div class="logo"></div></div>'+
			'<div class="toEditor" data-animationIn="fadeInUp 1.1s 0.5s"><a href="/h5/muqin" class="btn_03 flashBtn"><span>我也做一个</span></a>' + (isWX?('<a href="' + (iOS?'http://mp.weixin.qq.com/s?__biz=MjM5NzI3NDg4MA==&mid=202118832&idx=1&sn=537a80cac54948c45ea94ec135232d93#rd':'weixin://profile/people_rmw') + '" class="btn_01" style="margin-left:1em;"><span>抽魅蓝note</span></a>'):'') + '</div></div>';
