(function(){
	...
	if(isWX){
		if(location.host.indexOf('.people.com.cn') === -1){
			location.href = 'http://mblog.people.com.cn/h5/thisyear';
			return;
		};
	};
	var mul_table = [
	...
	var load = {
		...
		elements : [ //需要加载的元素
			...
			['bg_50.jpg', 'bg_end_50.jpg', 'subtitle_05.png', 'title_05.png'],
			['bg_60.jpg', 'bg_end_60.jpg', 'subtitle_06.png'],
			['bg_70.jpg', 'bg_end_70.jpg', 'subtitle_07.png']
		],
		defaultTxtIndex : 0,
		endTxt : [
	...
	'</div>';
		...
		//ad end
			'<div class="toEditor"><a href="http://mblog.people.com.cn/h5/thisyear" class="btn_01 flashBtn"></a>' + '</div>' +
			'<div class="styleIcons"><ol>' +
		'<li><a href="javascript:void(0)" onclick="toEditor(1)"><img data-src="http://i0.peopleurl.cn/microblog-v3/h5/thisyear/images/tlt1-4_03.png" alt=""></a></li>' +
		'<li><a href="javascript:void(0)" onclick="toEditor(2)"><img data-src="http://i0.peopleurl.cn/microblog-v3/h5/thisyear/images/tlt1-4_05.png" alt=""></a></li>' +
		'<li><a href="javascript:void(0)" onclick="toEditor(3)"><img data-src="http://i0.peopleurl.cn/microblog-v3/h5/thisyear/images/tlt1-4_07.png" alt=""></a></li>' +
		'<li><a href="javascript:void(0)" onclick="toEditor(4)"><img data-src="http://i0.peopleurl.cn/microblog-v3/h5/thisyear/images/tlt1-4_09.png" alt=""></a></li>' +
	'</ol></div></div>';
			$('.slideshow').html(html);
