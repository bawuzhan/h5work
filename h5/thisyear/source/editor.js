	...
	var editor = {
		...
		allDefaultTxt : [
			[
				...
				'一路伴我成长，青丝换白发。',
				'倾其一生，只因那一句简单的爸妈。',
				'而今忙于应对生活的我，何曾付出同样的耐心？',
				'只愿以后的日子，给你们最多的陪伴，就是最好的报答。'
			],
			[
				'所谓白头到老，没什么秘诀。',
				'只是在相爱时，存下点感动。',
			...
			[
				'我们把童年丢了，把青春掉了。',
				'时光一直都在，只是我们在飞逝。',
				'无论何时何地，想倾诉时能倾诉，想吐槽时能吐槽。',
				'其实友情就是这样，无需刻意想起，无需费心维系。',
				'哪怕相隔再远，想到你都会踏实。',
				'这一秒朋友，这一世朋友。',
				'促膝把酒，只有今生怎能够？'
			],
		...
		elements : [ //需要加载的元素
			['bg_01.jpg', 'bg_end_01.jpg', 'subtitle_01.png', 'title_01.png'],
			['bg_02.jpg', 'bg_end_02.jpg', 'subtitle_02.png', 'title_02.png'],
			['bg_03.jpg', 'bg_end_03.jpg', 'subtitle_03.png', 'title_03.png'],
			['bg_04.jpg', 'bg_end_04.jpg', 'subtitle_04.png', 'title_04.png'],
		],
		defaultTxtIndex : 0,
		endTxt : [
		...
		setStyle : function(s){
			...
			$('#lastPageImg').attr('src' , this.imagePath + 'tc_icon_n_0' + this.style + '.jpg');
	...
	'</div>';
		...
		uploadJSON : function(){
			...
			if(id){
				...
				showMessage('请稍候...');
				window.location.href = 'http://mblog.people.com.cn/wx/thisyear/' + id;
				return;
			};
